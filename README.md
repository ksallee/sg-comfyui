...
Then restart ComfyUI, open **Settings, then SG**, enter the site address and click **Sign in**.
...
publish defaults: Version name, root name, status, and where Published Files land.
